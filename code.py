...
keyboard.keymap = [
    [KC.ESCAPE , KC.Q, KC.W, KC.F, KC.P, KC.G,          KC.J, KC.L, KC.U, KC.Y, KC.SCOLON, KC.EQUAL,
     ...
     KC.LSHIFT , KC.Z, KC.X, KC.C, KC.V, KC.B,      KC.K, KC.M, KC.COMMA, KC.DOT, KC.SLASH, KC.RSHIFT,
     KC.NO, KC.NO, KC.NO, KC.LGUI, KC.LEFT_CONTROL, KC.BSPACE, KC.SPACE, KC.ENTER, KC.RALT, KC.NO, KC.NO, KC.NO
     ]
